...
const UpdateBuilding = ({ params }: IDProps) => {
    const { id } = params;

    const { data } = useBuildingQuery(id);
    ...
    return (
        <div>
            ...
            />
            <h1 className="py-5 text-lg font-bold">Update Building</h1>
            ...
            <Form submitHandler={onSubmit} defaultValues={defaultValues}>
                ...
                <button type="submit" className="bg-indigo-700 px-4 py-2 text-white rounded font-semibold">Update Building</button>
            </Form>
        </div>
    );
};
